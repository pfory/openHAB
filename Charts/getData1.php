...
$qry = "select time, dateFormated, value from (SELECT time, date_format(time, '%H:%i') dateFormated, value FROM openhab.Item70 order by 1 desc limit 100 ) as der order by 1 asc";
